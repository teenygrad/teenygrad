...
Yes. Very simple rust kernel sent and LLVM IR generated.

- Good
  - Basic compiler flow to LLVM IR done.

- Bad
  - velocity has reduced due to other commitments.
  - Reinforcement learning paper presentation is taking an awful lot of time, but worth the investment.
