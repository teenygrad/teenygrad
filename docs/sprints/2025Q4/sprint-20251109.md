...
1. Get SpinorML blog up and running.
2. Post 1 video on youtube and promote.
3. Complete initial version of triton DSL.
...
No, the triton dsl approach changed.

- Good
  - Good progress on trait bassed DSL.
  - LMcache presentation went well.

- Bad
  - None.

- Ugly
  - Triton dialect type system is horrendous. Because it was based on the python API, it has meant that the type system is too.
