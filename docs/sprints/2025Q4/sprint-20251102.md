...
No. The triton MLIR definition made the current DSL no longer fit for purpose. A new trait based approach is being tried, we should see by the end of the next sprint if that approach works better.

- Good
  - Bad triton DSL caught early.
