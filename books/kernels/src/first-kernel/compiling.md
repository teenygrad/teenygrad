...
It returns a path. What lands there is PTX, and beside it — same name, `.mlir`
extension — is the intermediate MLIR. The MLIR is the more useful of the two.
...
device's, so the snapshot is the same everywhere.
