...
[`teeny-vision`](https://docs.teenygrad.org/api/teeny-vision/)'s LeNet-5 over MNIST:
...
- **Ahead-of-time kernel compilation**: `utilities/teeny-cli/src/main.rs` — traces the model with
  ...
  [`teeny_cli::aot_compile`](https://docs.teenygrad.org/api/teeny-cli/).

## The shape of a model

Models are built from `teeny-core`'s [`nn`](https://docs.teenygrad.org/api/teeny-core/nn/) layer
