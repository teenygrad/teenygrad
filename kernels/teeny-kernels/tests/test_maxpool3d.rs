...
fn test_maxpool3d_forward_mlir_output() -> Result<()> {
    ...
    assert_debug_snapshot!("maxpool3d_forward_source", kernel.source());
    assert_debug_snapshot!("maxpool3d_forward_mlir", mlir.trim());
...
fn test_maxpool3d_backward_mlir_output() -> Result<()> {
    ...
    assert_debug_snapshot!("maxpool3d_backward_source", kernel.source());
    assert_debug_snapshot!("maxpool3d_backward_mlir", mlir.trim());
...
#[test]
#[cfg(feature = "cuda")]
fn test_maxpool3d_forward_cuda() -> Result<()> {
    dotenv().ok();
...
#[test]
#[cfg(feature = "cuda")]
fn test_maxpool3d_backward_cuda() -> Result<()> {
    dotenv().ok();
    let env = testing::setup_cuda_env()?;
    let device = env.device;
