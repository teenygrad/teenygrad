...
fn test_maxpool3d_forward_mlir_output() -> Result<()> {
    ...
    let kernel = teeny_kernels::pool::maxpool3d::Maxpool3dForward::<
        f32,
        KD,
        KH,
        KW,
...
fn test_maxpool3d_backward_mlir_output() -> Result<()> {
    ...
    let kernel = teeny_kernels::pool::maxpool3d::Maxpool3dBackward::<
        f32,
        KD,
        KH,
        KW,
...
fn test_maxpool3d_forward_cuda() -> Result<()> {
    ...
    let input_host = load_fixture("maxpool3d/x.bin");
    let expected = load_fixture("maxpool3d/expected_forward.bin");
    ...
    let program = testing::load_program_from_ptx::<
        teeny_kernels::pool::maxpool3d::Maxpool3dForward<
            f32,
            KD,
            KH,
            KW,
...
fn test_maxpool3d_backward_cuda() -> Result<()> {
    ...
    let x_host = load_fixture("maxpool3d/x.bin");
    let dy_host = load_fixture("maxpool3d/dy.bin");
    let expected_fwd = load_fixture("maxpool3d/expected_forward.bin");
    let expected = load_fixture("maxpool3d/expected_backward.bin");
    ...
    let program = testing::load_program_from_ptx::<
        teeny_kernels::pool::maxpool3d::Maxpool3dBackward<
            f32,
            KD,
            KH,
            KW,
