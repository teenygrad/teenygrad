...
fn test_maxpool2d_forward_mlir_output() -> Result<()> {
    ...
    let kernel = teeny_kernels::pool::maxpool2d::Maxpool2dForward::<
        f32,
        KH,
        KW,
        STRIDE_H,
...
fn test_maxpool2d_backward_mlir_output() -> Result<()> {
    ...
    let kernel = teeny_kernels::pool::maxpool2d::Maxpool2dBackward::<
        f32,
        KH,
        KW,
        STRIDE_H,
...
fn test_maxpool2d_forward_cuda() -> Result<()> {
    ...
    let program = testing::load_program_from_ptx::<
        teeny_kernels::pool::maxpool2d::Maxpool2dForward<f32, KH, KW, STRIDE_H, STRIDE_W, BLOCK_OW>,
    >(&ptx)?;
...
fn test_maxpool2d_backward_cuda() -> Result<()> {
    ...
    let program = testing::load_program_from_ptx::<
        teeny_kernels::pool::maxpool2d::Maxpool2dBackward<
            f32,
            KH,
            KW,
            STRIDE_H,
