...
mlir_snap!(test_hardtanh_mlir,    teeny_kernels::nn::activation::hard::HardtanhForward<f32>,    "hardtanh_forward_source",    "hardtanh_forward_mlir");
mlir_snap!(test_relu6_mlir,       teeny_kernels::nn::activation::hard::Relu6Forward<f32>,       "relu6_forward_source",       "relu6_forward_mlir");
mlir_snap!(test_hardsigmoid_mlir, teeny_kernels::nn::activation::hard::HardsigmoidForward<f32>, "hardsigmoid_forward_source", "hardsigmoid_forward_mlir");
mlir_snap!(test_hardswish_mlir,   teeny_kernels::nn::activation::hard::HardswishForward<f32>,   "hardswish_forward_source",   "hardswish_forward_mlir");
mlir_snap!(test_hardshrink_mlir,  teeny_kernels::nn::activation::hard::HardshrinkForward<f32>,  "hardshrink_forward_source",  "hardshrink_forward_mlir");
