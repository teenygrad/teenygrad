...
fn test_lppool3d_forward_mlir_output() -> Result<()> {
    ...
    let kernel = teeny_kernels::pool::lppool3d::Lppool3dForward::<
        f32,
        KD,
        KH,
        KW,
...
fn test_lppool3d_backward_mlir_output() -> Result<()> {
    ...
    let kernel = teeny_kernels::pool::lppool3d::Lppool3dBackward::<
        f32,
        KD,
        KH,
        KW,
...
fn test_lppool3d_forward_cuda() -> Result<()> {
    ...
    let program = testing::load_program_from_ptx::<
        teeny_kernels::pool::lppool3d::Lppool3dForward<
            f32,
            KD,
            KH,
            KW,
...
fn test_lppool3d_backward_cuda() -> Result<()> {
    ...
    let program = testing::load_program_from_ptx::<
        teeny_kernels::pool::lppool3d::Lppool3dBackward<
            f32,
            KD,
            KH,
            KW,
