...
fn test_reflection_pad3d_forward_cuda() -> Result<()> {
    ...
    let input_host = load_fixture(env!("CARGO_MANIFEST_DIR"), "reflection_pad3d/x.bin");
    let expected = load_fixture(
        env!("CARGO_MANIFEST_DIR"),
        "reflection_pad3d/expected_forward.bin",
    );
...
fn test_reflection_pad3d_backward_cuda() -> Result<()> {
    ...
    let dy_host = load_fixture(env!("CARGO_MANIFEST_DIR"), "reflection_pad3d/dy.bin");
    let expected = load_fixture(
        env!("CARGO_MANIFEST_DIR"),
        "reflection_pad3d/expected_backward.bin",
    );
