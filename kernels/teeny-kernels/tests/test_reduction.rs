...
macro_rules! gpu_reduce_test {
    ($test_name:ident, $kernel_ty:ty, $fixture_op:literal, $op_name:literal) => {
        ...
        fn $test_name() -> Result<()> {
            ...
            let expected =
                load_fixture(concat!("reduction/expected_", $fixture_op, ".bin"));
            let n_total = x.len();
...
source_test!(test_reduce_sum_source,         ReduceSumForward::<f32>,        "reduce_sum_forward");
source_test!(test_reduce_mean_source,        ReduceMeanForward::<f32>,       "reduce_mean_forward");
source_test!(test_reduce_max_source,         ReduceMaxForward::<f32>,        "reduce_max_forward");
source_test!(test_reduce_min_source,         ReduceMinForward::<f32>,        "reduce_min_forward");
source_test!(test_reduce_prod_source,        ReduceProdForward::<f32>,       "reduce_prod_forward");
source_test!(test_reduce_l1_source,          ReduceL1Forward::<f32>,         "reduce_l1_forward");
source_test!(test_reduce_l2_source,          ReduceL2Forward::<f32>,         "reduce_l2_forward");
source_test!(test_reduce_log_sum_source,     ReduceLogSumForward::<f32>,     "reduce_log_sum_forward");
source_test!(test_reduce_log_sum_exp_source, ReduceLogSumExpForward::<f32>,  "reduce_log_sum_exp_forward");
source_test!(test_reduce_sum_square_source,  ReduceSumSquareForward::<f32>,  "reduce_sum_square_forward");
source_test!(test_cum_sum_source,            CumSumForward::<f32>,           "cum_sum_forward");
source_test!(test_cum_prod_source,           CumProdForward::<f32>,          "cum_prod_forward");
source_test!(test_global_avg_pool_source,    GlobalAvgPoolForward::<f32>,    "global_avg_pool_forward");
source_test!(test_global_max_pool_source,    GlobalMaxPoolForward::<f32>,    "global_max_pool_forward");

// ── GPU forward tests ─────────────────────────────────────────────────────────

gpu_reduce_test!(test_reduce_sum_gpu,         ReduceSumForward::<f32>,       "reduce_sum",        "reduce_sum");
...
gpu_reduce_test!(test_reduce_log_sum_exp_gpu, ReduceLogSumExpForward::<f32>, "reduce_log_sum_exp","reduce_log_sum_exp");
gpu_reduce_test!(test_reduce_sum_square_gpu,  ReduceSumSquareForward::<f32>, "reduce_sum_square", "reduce_sum_square");
gpu_reduce_test!(test_global_avg_pool_gpu,    GlobalAvgPoolForward::<f32>,   "global_avg_pool",   "global_avg_pool");
