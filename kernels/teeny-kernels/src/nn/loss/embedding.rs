...
pub fn triplet_margin_loss_forward<T: Triton, const BLOCK_SIZE: i32>(
    anchor_ptr: In<T::Pointer<f32>>,
    positive_ptr: In<T::Pointer<f32>>,
    negative_ptr: In<T::Pointer<f32>>,
    out_ptr: Out<T::Pointer<f32>>,
    _n_rows: i32,
    n_dim: i32,
    margin: f32,
...
pub fn triplet_margin_loss_backward<T: Triton, const BLOCK_SIZE: i32>(
    ...
    positive_ptr: In<T::Pointer<f32>>,
    negative_ptr: In<T::Pointer<f32>>,
    da_ptr: Out<T::Pointer<f32>>,
    dp_ptr: Out<T::Pointer<f32>>,
    dn_ptr: Out<T::Pointer<f32>>,
    _n_rows: i32,
    n_dim: i32,
    margin: f32,
    eps: f32,
