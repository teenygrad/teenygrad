...
/// 2-D replication padding forward pass.
///
/// Grid: `pid = ((b*C+c)*OH+oh) * num_ow_tiles + ow_tile`
#[kernel]
pub fn replication_pad2d_forward<
    T: Triton,
    D: Float,
    const PT: i32,
    const PB: i32,
...
/// 2-D replication padding backward pass.
#[kernel]
...
pub struct ReplicationPad2dOp<'a, T: Float> {
    pub forward: ReplicationPad2dForward<T>,
    pub backward: ReplicationPad2dBackward<T>,
