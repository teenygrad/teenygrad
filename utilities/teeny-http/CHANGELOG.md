...
## [0.1.0](https://github.com/teenygrad/teenygrad/releases/tag/teeny-http-v0.1.0) - 2026-07-29
...
- added progress indicator while downloading models
- added file download with progress tracking
- wip qwen 3 using ndarrays
- added http utlities crate
